...
!!! info
    ...
    **Source Code Repository:** [https://github.com/redhat-appstudio-mjf/ls4-jan172026](https://github.com/redhat-appstudio-mjf/ls4-jan172026)

    **GitOps Repository:** [https://github.com/redhat-appstudio-mjf/ls4-jan172026-gitops](https://github.com/redhat-appstudio-mjf/ls4-jan172026-gitops)
...
To access the ls4-jan172026 application that was deployed using the Software Template, complete the following instructions:
...
If you are interested in seeing the deployed OpenShift/Kubernetes resources, all resources were deployed into your chosen project/namespace of hello4. You can access this project/namespace through the web console (if available) or via your CLI.
